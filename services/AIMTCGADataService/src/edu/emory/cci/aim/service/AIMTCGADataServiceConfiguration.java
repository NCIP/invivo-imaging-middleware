 ...
 * 
 */
public class AIMTCGADataServiceConfiguration implements ServiceConfiguration {

	public static AIMTCGADataServiceConfiguration  configuration = null;

	public static AIMTCGADataServiceConfiguration getConfiguration() throws Exception {
		if (AIMTCGADataServiceConfiguration.configuration != null) {
			return AIMTCGADataServiceConfiguration.configuration;
		}
		...
		try {
			...
			AIMTCGADataServiceConfiguration.configuration = (AIMTCGADataServiceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
