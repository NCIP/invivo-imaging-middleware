 ...
 * 
 */
public class ImageDataServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://imagedataservice.ivi.nci.nih.gov/ImageDataService";
	
	
	public ImageDataServiceAuthorization() {
	}
	...
	public static void authorizeRetrieveImageData() throws RemoteException {
		
		
	}
					
	public static void authorizeSubmitImageData() throws RemoteException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		} else if(operation.getLocalPart().equals("retrieveImageData")){
			try{
				authorizeRetrieveImageData();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
			}
		} else if(operation.getLocalPart().equals("submitImageData")){
			try{
				authorizeSubmitImageData();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
