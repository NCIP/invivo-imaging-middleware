 ...
 * 
 */
public class AIMv1DataServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://aim.cci.emory.edu/AIMv1DataService";
	
	
	public AIMv1DataServiceAuthorization() {
	}
