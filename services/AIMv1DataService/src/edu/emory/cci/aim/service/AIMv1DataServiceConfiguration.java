 ...
 * 
 */
public class AIMv1DataServiceConfiguration implements ServiceConfiguration {

	public static AIMv1DataServiceConfiguration  configuration = null;

	public static AIMv1DataServiceConfiguration getConfiguration() throws Exception {
		if (AIMv1DataServiceConfiguration.configuration != null) {
			return AIMv1DataServiceConfiguration.configuration;
		}
		...
		try {
			...
			AIMv1DataServiceConfiguration.configuration = (AIMv1DataServiceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
