...
import gov.nih.nci.ivi.pathologydataservice.service.PathologyDataServiceConfiguration;
import java.io.File;
 ...
 * 
 */
public abstract class PathologyDataServiceResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(PathologyDataServiceResourceBase.class);

	private PathologyDataServiceResourceConfiguration configuration;
    ...
    public PathologyDataServiceResourceBase() {
    }
	...
	public gov.nih.nci.cagrid.metadata.ServiceMetadata getServiceMetadata(){
		return ((PathologyDataServiceResourceProperties) getResourceBean()).getServiceMetadata();
	}
	
	public void setServiceMetadata(gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(PathologyDataServiceConstants.SERVICEMETADATA);
	...
	public gov.nih.nci.cagrid.metadata.dataservice.DomainModel getDomainModel(){
		return ((PathologyDataServiceResourceProperties) getResourceBean()).getDomainModel();
	}
	
	public void setDomainModel(gov.nih.nci.cagrid.metadata.dataservice.DomainModel domainModel ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(PathologyDataServiceConstants.DOMAINMODEL);
	...
	public PathologyDataServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/PathologyDataService";
		...
		try {
			...
			this.configuration = (PathologyDataServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
	...
	private void loadServiceMetadataFromFile() {
      if(getServiceMetadata()==null){
		try {
			...
			((PathologyDataServiceResourceProperties) this.getResourceBean()).setServiceMetadata((gov.nih.nci.cagrid.metadata.ServiceMetadata) Utils.deserializeDocument(dataFile.getAbsolutePath(),
