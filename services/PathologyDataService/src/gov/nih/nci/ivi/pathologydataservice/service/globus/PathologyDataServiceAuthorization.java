 ...
 * 
 */
public class PathologyDataServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://pathologydataservice.ivi.nci.nih.gov/PathologyDataService";
	
	
	public PathologyDataServiceAuthorization() {
	}
	...
	public static void authorizeView() throws RemoteException {
		
		
	}
					
	public static void authorizeRetrieve() throws RemoteException {
	...
	public static void authorizeDelete() throws RemoteException {
	...
	public static void authorizeRetrieveThumbnail() throws RemoteException {
		
		
	}
					
	public static void authorizeGetWidth() throws RemoteException {
		
		
	}
					
	public static void authorizeGetHeight() throws RemoteException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		} else if(operation.getLocalPart().equals("view")){
			try{
				authorizeView();
				return true;
			} catch (Exception e){
		...
		} else if(operation.getLocalPart().equals("retrieve")){
			try{
				authorizeRetrieve();
				return true;
			} catch (Exception e){
		...
		} else if(operation.getLocalPart().equals("retrieveThumbnail")){
			try{
				authorizeRetrieveThumbnail();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
			}
		} else if(operation.getLocalPart().equals("getWidth")){
			try{
				authorizeGetWidth();
				return true;
			} catch (Exception e){
		...
		} else if(operation.getLocalPart().equals("getHeight")){
			try{
				authorizeGetHeight();
				return true;
			} catch (Exception e){
