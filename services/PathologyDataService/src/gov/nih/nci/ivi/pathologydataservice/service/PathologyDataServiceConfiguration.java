 ...
 * 
 */
public class PathologyDataServiceConfiguration implements ServiceConfiguration {

	public static PathologyDataServiceConfiguration  configuration = null;

	public static PathologyDataServiceConfiguration getConfiguration() throws Exception {
		if (PathologyDataServiceConfiguration.configuration != null) {
			return PathologyDataServiceConfiguration.configuration;
		}
		...
		try {
			...
			PathologyDataServiceConfiguration.configuration = (PathologyDataServiceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
	...
	private String cqlQueryProcessorConfig_rootDir;
	...
	public String getTmpStorage() {
		return ContainerConfig.getBaseDirectory() + File.separator + tmpStorage;
	}
	...
	public String getCqlQueryProcessorConfig_rootDir() {
		return cqlQueryProcessorConfig_rootDir;
	}
	
	
	public void setCqlQueryProcessorConfig_rootDir(String cqlQueryProcessorConfig_rootDir) {
		this.cqlQueryProcessorConfig_rootDir = cqlQueryProcessorConfig_rootDir;
	}
