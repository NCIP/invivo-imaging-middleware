 ...
 * 
 */
public class AIM3DataServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://aim.cci.emory.edu/AIM3DataService";
	
	Map authorizationClassMap = new HashMap();
	
	
	public AIM3DataServiceAuthorization() {
	}
	...
	public void authorizeEnumerationQuery(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
		
	}
	   				
	public void authorizeSubmit(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
		
	}
	   				
	public void authorizeQueryByTransfer(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
		
	}
	   				
	public void authorizeSubmitByTransfer(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getMultipleResourceProperties")){
			...
			authorizeEnumerationQuery(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("submit")){
			authorizeSubmit(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("queryByTransfer")){
			authorizeQueryByTransfer(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("submitByTransfer")){
			authorizeSubmitByTransfer(peerSubject, context, operation);
			return true;
		} 		
		return false;
	}
