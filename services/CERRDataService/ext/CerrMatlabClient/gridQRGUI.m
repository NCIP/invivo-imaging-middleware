...
% --- Executes on button press in query Button.
...
% handles    structure with handles and user data (see GUIDATA)
       ...
       gridQueryCERR(inputQuery, cerrURL);;
       close;
...
set(hObject, 'String', {'http://127.0.0.1:8080', 'http://170.140.187.81:8080', 'http://140.254.80.50:50015'});
