package gov.nih.nci.ivi.dsdrepositoryservice.service.globus.resource;
...
import gov.nih.nci.ivi.dsdrepositoryservice.common.DSDRepositoryServiceConstants;
import gov.nih.nci.ivi.dsdrepositoryservice.stubs.DSDRepositoryServiceResourceProperties;
 ...
 * 
 */
public abstract class DSDRepositoryServiceResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(DSDRepositoryServiceResourceBase.class);

	private DSDRepositoryServiceResourceConfiguration configuration;
    ...
    public DSDRepositoryServiceResourceBase() {
    }
	...
	public gov.nih.nci.cagrid.metadata.ServiceMetadata getServiceMetadata(){
		return ((DSDRepositoryServiceResourceProperties) getResourceBean()).getServiceMetadata();
	}
	
	public void setServiceMetadata(gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(DSDRepositoryServiceConstants.SERVICEMETADATA);
	...
	public gov.nih.nci.cagrid.metadata.dataservice.DomainModel getDomainModel(){
		return ((DSDRepositoryServiceResourceProperties) getResourceBean()).getDomainModel();
	}
	
	public void setDomainModel(gov.nih.nci.cagrid.metadata.dataservice.DomainModel domainModel ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(DSDRepositoryServiceConstants.DOMAINMODEL);
	...
	public DSDRepositoryServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/DSDRepositoryService";
		...
		try {
			...
			this.configuration = (DSDRepositoryServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
	...
	private void loadServiceMetadataFromFile() {
      if(getServiceMetadata()==null){
		try {
			...
			((DSDRepositoryServiceResourceProperties) this.getResourceBean()).setServiceMetadata((gov.nih.nci.cagrid.metadata.ServiceMetadata) Utils.deserializeDocument(dataFile.getAbsolutePath(),
