package gov.nih.nci.ivi.dsdcontainerservice.service.globus.resource;
...
import gov.nih.nci.ivi.dsdcontainerservice.common.DSDContainerServiceConstants;
import gov.nih.nci.ivi.dsdcontainerservice.stubs.DSDContainerServiceResourceProperties;
 ...
 * 
 */
public abstract class DSDContainerServiceResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(DSDContainerServiceResourceBase.class);

	private DSDContainerServiceResourceConfiguration configuration;
    ...
    public DSDContainerServiceResourceBase() {
    }
	...
	public gov.nih.nci.cagrid.metadata.ServiceMetadata getServiceMetadata(){
		return ((DSDContainerServiceResourceProperties) getResourceBean()).getServiceMetadata();
	}
	
	public void setServiceMetadata(gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(DSDContainerServiceConstants.SERVICEMETADATA);
	...
	public DSDContainerServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/DSDContainerService";
		...
		try {
			...
			this.configuration = (DSDContainerServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
	...
	private void loadServiceMetadataFromFile() {
      if(getServiceMetadata()==null){
		try {
			...
			((DSDContainerServiceResourceProperties) this.getResourceBean()).setServiceMetadata((gov.nih.nci.cagrid.metadata.ServiceMetadata) Utils.deserializeDocument(dataFile.getAbsolutePath(),
