...
public class SourceUtils
{
		...
		throws RecognitionException, TokenStreamException, IOException
	{
		...
		String[] lines = inMethod.getLines(-1);
		for(int i = 0; i < lines.length; i++){
			outMethod.addLine(lines[i]);
		}
	...
	public static void modifyImpl(File sourceJava, File targetJava, String methodName) 
		throws IOException
	{
		...
		targetContent.insert(targetEndOfSignature, 
			sourceContent.substring(sourceEndOfSignature, sourceEndOfImplementation)
		);
	...
	public static int startOfSignature(StringBuffer sb, String methodName) 
		throws IOException 
	{
