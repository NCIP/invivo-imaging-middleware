...
public class AIMv1DataServiceHelper {

	boolean debug;

	public AIMv1DataServiceHelper() {
		//may modify to handle security
		//One of the properties that must be created when using
	}

	public void retrieveAnnotations(CQLQuery cqlQuery, String dataSourceURL) throws MalformedURIException, RemoteException {
		AIMv1DataServiceClient imageClient;
			imageClient = new AIMv1DataServiceClient(dataSourceURL);
	...
	public void retrieveAnnotations(CQLQuery cqlQuery, String dataSourceURL,
		...
		AIMv1DataServiceClient aimDataService;
		InputStream istream = null;
		TransferServiceContextClient tclient = null;

			aimDataService = new AIMv1DataServiceClient(dataSourceURL);
	...
	public void submitAnnotations(String aimFilesToBeUploaded,
		...
		AIMv1DataServiceClient aimDataService = null;
		aimDataService = new AIMv1DataServiceClient(dataDestinationURL);
