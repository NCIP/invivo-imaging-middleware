 ...
 * 
 */
public class DSDRepositoryServiceConfiguration implements ServiceConfiguration {

	public static DSDRepositoryServiceConfiguration  configuration = null;

	public static DSDRepositoryServiceConfiguration getConfiguration() throws Exception {
		if (DSDRepositoryServiceConfiguration.configuration != null) {
			return DSDRepositoryServiceConfiguration.configuration;
		}
		...
		try {
			...
			DSDRepositoryServiceConfiguration.configuration = (DSDRepositoryServiceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
