 ...
 * 
 */
public class DSDRepositoryServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://dsdrepositoryservice.ivi.nci.nih.gov/DSDRepositoryService";
	
	
	public DSDRepositoryServiceAuthorization() {
	}
	...
	public static void authorizeDeploy() throws RemoteException {
		
		
	}
					
	public static void authorizeUndeploy() throws RemoteException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		} else if(operation.getLocalPart().equals("deploy")){
			try{
				authorizeDeploy();
				return true;
			} catch (Exception e){
		...
		} else if(operation.getLocalPart().equals("undeploy")){
			try{
				authorizeUndeploy();
				return true;
			} catch (Exception e){
