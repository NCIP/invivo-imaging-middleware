 ...
 * 
 */
public class AIMTCGADataServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://aim.cci.emory.edu/AIMTCGADataService";
	
	
	public AIMTCGADataServiceAuthorization() {
	}
