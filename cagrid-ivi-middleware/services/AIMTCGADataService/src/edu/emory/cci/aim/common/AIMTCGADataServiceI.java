 ...
 * 
 */
public interface AIMTCGADataServiceI {
  ...
  /**
   * The standard caGrid Data Service query method which begins an Enumeration
   *
   * @param cqlQuery
   *	The CQL query to be executed against the data source.
   * @return The enumerate response containing the EPR of the enumeration resource
   * @throws QueryProcessingException
   *	Thrown when an error occurs in processing a CQL query
   * @throws MalformedQueryException
   *	Thrown when a query is found to be improperly formed
