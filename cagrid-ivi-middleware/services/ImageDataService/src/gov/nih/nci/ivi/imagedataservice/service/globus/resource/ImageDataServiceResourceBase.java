...
import gov.nih.nci.ivi.imagedataservice.service.ImageDataServiceConfiguration;
import java.io.File;
 ...
 * 
 */
public abstract class ImageDataServiceResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(ImageDataServiceResourceBase.class);

	private ImageDataServiceResourceConfiguration configuration;
    ...
    public ImageDataServiceResourceBase() {
    }
	...
	public gov.nih.nci.cagrid.metadata.ServiceMetadata getServiceMetadata(){
		return ((ImageDataServiceResourceProperties) getResourceBean()).getServiceMetadata();
	}
	
	public void setServiceMetadata(gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(ImageDataServiceConstants.SERVICEMETADATA);
	...
	public gov.nih.nci.cagrid.metadata.dataservice.DomainModel getDomainModel(){
		return ((ImageDataServiceResourceProperties) getResourceBean()).getDomainModel();
	}
	
	public void setDomainModel(gov.nih.nci.cagrid.metadata.dataservice.DomainModel domainModel ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(ImageDataServiceConstants.DOMAINMODEL);
	...
	public ImageDataServiceResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (ImageDataServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
	...
	private void loadServiceMetadataFromFile() {
      if(getServiceMetadata()==null){
		try {
			...
			((ImageDataServiceResourceProperties) this.getResourceBean()).setServiceMetadata((gov.nih.nci.cagrid.metadata.ServiceMetadata) Utils.deserializeDocument(dataFile.getAbsolutePath(),
