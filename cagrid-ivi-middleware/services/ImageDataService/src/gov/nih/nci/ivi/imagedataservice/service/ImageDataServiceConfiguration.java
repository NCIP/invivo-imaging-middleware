 ...
 * 
 */
public class ImageDataServiceConfiguration implements ServiceConfiguration {

	public static ImageDataServiceConfiguration  configuration = null;

	public static ImageDataServiceConfiguration getConfiguration() throws Exception {
		if (ImageDataServiceConfiguration.configuration != null) {
			return ImageDataServiceConfiguration.configuration;
		}
		...
		try {
			...
			ImageDataServiceConfiguration.configuration = (ImageDataServiceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
