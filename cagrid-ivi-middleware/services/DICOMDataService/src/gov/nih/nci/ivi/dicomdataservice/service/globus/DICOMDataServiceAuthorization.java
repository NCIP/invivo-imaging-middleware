 ...
 * 
 */
public class DICOMDataServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://dicomdataservice.ivi.nci.nih.gov/DICOMDataService";
	
	
	public DICOMDataServiceAuthorization() {
	}
	...
	public static void authorizeSubmitDICOMData() throws RemoteException {
		
		
	}
					
	public static void authorizeRetrieveDICOMDataProgressively() throws RemoteException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		} else if(operation.getLocalPart().equals("submitDICOMData")){
			try{
				authorizeSubmitDICOMData();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
			}
		} else if(operation.getLocalPart().equals("retrieveDICOMDataProgressively")){
			try{
				authorizeRetrieveDICOMDataProgressively();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
