...
import edu.emory.cci.aim.stubs.AIMv1DataServicePortType;
import edu.emory.cci.aim.stubs.service.AIMv1DataServiceAddressingLocator;
import edu.emory.cci.aim.common.AIMv1DataServiceI;
 ...
 */
public class AIMv1DataServiceClient extends AIMv1DataServiceClientBase implements AIMv1DataServiceI {	

	public AIMv1DataServiceClient(String url) throws MalformedURIException, RemoteException {
		this(url,null);	
	}

	public AIMv1DataServiceClient(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	}
	
	public AIMv1DataServiceClient(EndpointReferenceType epr) throws MalformedURIException, RemoteException {
	   	this(epr,null);
	}
	
	public AIMv1DataServiceClient(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
	}

	public static void usage(){
		System.out.println(AIMv1DataServiceClient.class.getName() + " -url <service url>");
	}
	...
	public static void main(String [] args){
		...
		if(!(args.length < 2)){
			if(args[0].equals("-url")){
			  AIMv1DataServiceClient client = new AIMv1DataServiceClient(args[1]);
