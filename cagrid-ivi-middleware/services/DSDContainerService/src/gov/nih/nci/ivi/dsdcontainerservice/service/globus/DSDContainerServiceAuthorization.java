 ...
 * 
 */
public class DSDContainerServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://dsdcontainerservice.ivi.nci.nih.gov/DSDContainerService";
	
	
	public DSDContainerServiceAuthorization() {
	}
